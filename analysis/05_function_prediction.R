...
if (file.exists(kegg_file) && file.size(kegg_file) > 0) {
    ...
    ggsave(file.path(output_dir, paste0(comp_suffix, "_Top20_KEGG_L2_Barplot.png")), p, width = 14, height = 8)
    ...
    if ("Group" %in% colnames(metadata)) {
        ...
        ggsave(file.path(output_dir, paste0(comp_suffix, "_Group_KEGG_L2_Composition.png")), p_group, width = 10, height = 7)
    }
